...
! function(a, b, c) {
    ...
    w = {
        ...
        windowContext: null
    }, s = "scrollbar", r = "scroll", k = "mousedown", l = "mousemove", n = "mousewheel", m = "mouseup", q = "resize", h = "drag", u = "up", p = "panedown", f = "DOMMouseScroll", g = "down", v = "wheel", i = "keydown", j = "keyup", t = "touchmove", d = "Microsoft Internet Explorer" === b.navigator.appName && /msie 7./i.test(b.navigator.appVersion) && b.ActiveXObject, e = null, A = b.requestAnimationFrame, C = c.createElement("div").style, E = function() {
        var a, b, c, d, e, f;
        for (d = ["t", "webkitT", "MozT", "msT", "OT"], a = e = 0, f = d.length; f > e; a = ++e) if (c = d[a], b = d[a] + "ransform", b in C) return d[a].substr(0, d[a].length - 1);
        return !1
    }(), D = function(a) {
        return E === !1 ? !1 : "" === E ? a : E + a.charAt(0).toUpperCase() + a.substr(1)
    }, B = D("transform"), y = B !== !1, x = function() {
        var a, b, d;
        ...
        return i.prototype.preventScrolling = function(a, b) {
            ...
            this.events = {
                ...
                scroll: function(c) {
                    var d;
                    a.isBeingDragged || (a.updateScrollValues(), a.iOSNativeScrolling || (a.sliderY = a.sliderTop, y ? (d = {}, d[B] = "translate(0, " + a.sliderTop + "px)") : d = {
                        top: a.sliderTop
                    }, A ? b.requestAnimationFrame(function() {
                        a.slider.css(d)
                    }) : a.slider.css(d)), null != c && (a.contentScrollTop >= a.maxScrollTop ? (a.options.preventPageScrolling && a.preventScrolling(c, g), a.prevScrollTop !== a.maxScrollTop && a.$el.trigger("scrollend")) : 0 === a.contentScrollTop && (a.options.preventPageScrolling && a.preventScrolling(c, u), 0 !== a.prevScrollTop && a.$el.trigger("scrolltop"))))
                },
                wheel: function(b) {
                    var c;
